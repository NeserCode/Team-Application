...
export default {
	...
	watch: {
		scrollYRate() {
			...
			this.$refs.ythumb.style.height =
				this.$refs.content.scrollHeight + "px"
		},
		scrollXRate() {
			this.$refs.xbar.style.left = this.scrollXRate + "px"
			this.$refs.xthumb.style.width =
				this.$refs.content.scrollWidth + "px"
		},
		scrollBarHeight() {
	...
	methods: {
		handleScroll: function () {
			...
			this.offsetThumbY =
				scrollLeft + offsetW - this.$refs.ythumb.offsetWidth
			this.offsetThumbX =
				scrollTop + offsetH - this.$refs.xthumb.offsetHeight
		},
		initBars: function () {
			let offsetW = this.$refs.content.offsetWidth,
				scrollW = this.$refs.content.scrollWidth,
